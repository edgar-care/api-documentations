...
* [💡 API Reference](reference/api-reference/README.md)
  ...
  * [👨⚕ Diagnostic](reference/api-reference/diagnostic/README.md)
    * [🔠 Exam using NLP](reference/api-reference/diagnostic/exam-using-nlp.md)
  ...
  * [🎛 Dashboard](reference/api-reference/dashboard.md)
